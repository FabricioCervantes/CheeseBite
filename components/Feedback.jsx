  ...
  return (
    <div className="flex justify-center mt-20">
      <div className="max-w-7xl">
        <h1 className="text-center text-6xl font-bold">CUSTOMERS FEEDBACK</h1>
        <h2 className="text-center mt-2">
          We care about our customers and their opinions are trully important to
          us
        </h2>
        <div className="-mx-3 md:flex items-start mt-10">
